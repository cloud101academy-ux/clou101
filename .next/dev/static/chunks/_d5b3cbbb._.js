          ...
          content
                ...
                if (postData?.categories?.length) {
                    const categoryIds = postData.categories.map({
                        "BlogPostClient.useEffect.fetchData.categoryIds": (c)=>c._id
                    }["BlogPostClient.useEffect.fetchData.categoryIds"]);
...
_s(BlogPostClient, "ZIC7fndhFPrlobZrELmLQbGYrIM=", false, function() {
    return [
...
//# sourceMappingURL=_d5b3cbbb._.js.map